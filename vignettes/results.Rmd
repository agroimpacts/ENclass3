...
##   We use reference data set to train and test year 2 model and use ggplot to create Random Forest variable importance plots. Mean decrease accuracy is the measure of the performance of the model without each variable.

##  We use ggplot to create Mean Decrease Accuracy plot, where shows how important it is in classifying the data for each variable. It expresses how much accuracy the model losses by excluding each variable. The more the accuracy suffers, the more important the variable is for the successful classification. The variables are presented from descending importance.

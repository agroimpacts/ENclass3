...
###  (2-1) Create predictor stacks: Create a bucket 'activemapper' for PlanetScope catogory (B G R NIR Alpha), Sentinel1_harmonic catalogs and sentinel2 band groups. Make sentinel stacks in nicfi tiles.  Create S1, S2, and Planet stack. (mk_rst_stack_en_2021.R)
